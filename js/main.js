...
function classic(){
  ...
  myProfile.style.borderColor = "white";

  var myEducation= document.querySelector(".education");
  myEducation.style.borderColor = "white";

  var myExperience= document.querySelector(".experience");
  myExperience.style.borderColor = "white";

  var mySkills= document.querySelector(".skills");
  mySkills.style.borderColor = "white";

  var myAwards= document.querySelector(".awards");
  myAwards.style.borderColor = "white";

  var myActivities= document.querySelector(".activities");
  myActivities.style.borderColor = "white";
